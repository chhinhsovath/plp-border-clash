...
export default function DataCollectionDashboard() {
  ...
  const getActivityColor = (action: string) => {
    if (action.includes('REGISTER')) return '#3b82f6'
    if (action.includes('DISTRIBUTION')) return '#f59e0b'
    if (action.includes('CLINICAL')) return '#10b981'
    if (action.includes('PROTECTION')) return '#dc2626'
    return '#6b7280'
  }
